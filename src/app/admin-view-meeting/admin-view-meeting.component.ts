...
@Component({
  selector: 'app-admin-view-meeting',
  templateUrl: './admin-view-meeting.component.html',
  styleUrls: ['./admin-view-meeting.component.css']
})
export class AdminViewMeetingComponent implements OnInit{
