...
public class AddClientPage {
    ...
    public void goToCreateClientForm() {
        driver.findElement(By.id("createClient")).click();
    }


    public void enterClientDetails(String clientName, String email, String address, String postalCode, String username, String password) {
    ...
    public String verifyClientLogin(String username, String password) {
    	WebElement userTypeDropdown = driver.findElement(By.id("userType"));
        userTypeDropdown.click();
