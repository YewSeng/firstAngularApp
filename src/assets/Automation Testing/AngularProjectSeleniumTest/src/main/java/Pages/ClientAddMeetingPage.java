...
public class ClientAddMeetingPage {

    private WebDriver driver;
    private WebDriverWait wait;
    
    public ClientAddMeetingPage(WebDriver driver) {
        this.driver = driver;
    ...
    public void goToCreateMeetingPage() {
        driver.findElement(By.id("createMeeting")).click();
    }

    public void createMeeting(String topic, String startDate, String startTime, String endDate, String endTime, String parties) {
